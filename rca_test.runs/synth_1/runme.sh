...
HD_PWD='C:/Users/rldnd/pjx/rca_test/rca_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rca_test.tcl
