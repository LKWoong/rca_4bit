...
HD_PWD='C:/Users/rldnd/pjx/rca_test/rca_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rca_test.tcl -notrace
